            ...
            <div className='flex min-h-screen flex-col justify-between'>
                <header className=''>
                    <Navbar fluid rounded className='border-b-2 '>
                        <Navbar.Brand as={Link} href="/" className='ml-4'>
                            <h1 className='text-2xl font font-sans'>DECODE Techlonolgies</h1>
                        </Navbar.Brand>
                        <Navbar.Toggle/>
                        <Navbar.Collapse>
                                <Link className='p-2 w-full flex' href="/checkout/cart">
                                ...
                                <div className='flex w-full '>
                                    {
                                        ...
                                        :
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 m-1 h-6">
