...
function AdminDashboard() {
    ...
    <Layout>
        <div className='min-w-lg '>
            <h1 className='text-center text-3xl m-7'>Dashboard</h1>
            <div className='flex justify-center'>
                <Button.Group className=' w-fit'>

                        <Button color='light' className={router.pathname.includes("dashboard") ? "bg-blue-100" : ""} onClick={()=>router.push("/admin/dashboard")}>
            ...
            <div className='w-screen m-auto grid md:grid-cols-4 md:gap-5'>
