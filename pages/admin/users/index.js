...
import { demoteAdmin, fetchUsers,promoteAdmin,deleteUser,clearError } from '../../../redux/slices/usersSlice';
  ...
  return (
    <Layout>
         <div className='min-w-lg '>
            {error && <Alert color="failure" className="my-7 px-5 w-fit mx-auto" onDismiss={()=>dispatch(clearError(""))}><span className='mx-3'>{error}</span></Alert>}
              <h1 className='text-center text-3xl m-7'>Users</h1>
              <div className='flex justify-center overflow-x-auto'>
                <Button.Group className='mb-20'>
            ...
            </div>
          {
            ...
            <Table>
                ...
                <Table.Body>
                  {
                    users?.map(user => (
                      <Table.Row key={user.id} className='border-b bg-white'>
                          ...
                          :
                          <Table.Cell><Button color="light" onClick={()=> delUser(user.id)}>Delete</Button></Table.Cell>
                          }
